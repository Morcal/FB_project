...
public class StickyNavLayout extends LinearLayout
{
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
	{
		...
		Log.d("lala", "first mode = " + mode +"size = " + size);
		mTop.measure(widthMeasureSpec, MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED));
		mNav.measure(widthMeasureSpec, MeasureSpec.makeMeasureSpec(mNav.getLayoutParams().height, MeasureSpec.EXACTLY));
		mViewPager.measure(widthMeasureSpec, MeasureSpec.makeMeasureSpec(getMeasuredHeight() - mNav.getMeasuredHeight() - 13*getPaddingBottom(), MeasureSpec.EXACTLY));
	...
	protected void onSizeChanged(int w, int h, int oldw, int oldh)
	{
		...
		Log.d("MainView1", "mTopViewHeight = " + mTopViewHeight);
	}
	...
	public void fling(int velocityY)
	{
		...
		Log.d("MainView", "mTopViewHeight = " + mTopViewHeight);
		invalidate();
	}
