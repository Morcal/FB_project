 ...
 */
public class OrdersWaitReceiptManager extends AbsOrdersManager {

    public OrdersWaitReceiptManager(ILoadingView loadingView) {
        super(loadingView);
    }

    @Override
    protected BaseDataType generateDataType() {
        return BaseDataType.OrdersDataType.WAIT_RECEIPT_ORDERS;
    }

    @Override
    protected void load(int curPage, String sinceId, boolean needCache, DaoListener listener) {
        SnacksDao.getOrderListHarvested(sinceId, curPage, listener);
    }
}
