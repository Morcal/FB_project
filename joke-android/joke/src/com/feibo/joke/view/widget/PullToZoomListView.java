...
public class PullToZoomListView extends CListView implements
	...
	public ImageView getHeaderView2() {
	...
	public void onScroll(AbsListView paramAbsListView, int paramInt1,
		...
		if ((f > 0.0F) && (f < this.mHeaderHeight)) {
		    //mHeaderHeight > mHeaderContainer.getBottom() && mHeaderContainer.getBottom()>0
	...
	public void setHeaderViewSize(int widthParams, int heightParams) {
		Object localObject = this.mHeaderContainer.getLayoutParams();
		if (localObject == null)
			localObject = new AbsListView.LayoutParams(widthParams, heightParams);
		((ViewGroup.LayoutParams) localObject).width = widthParams;
		((ViewGroup.LayoutParams) localObject).height = heightParams;
		this.mHeaderContainer
				.setLayoutParams((ViewGroup.LayoutParams) localObject);
		this.mHeaderHeight = heightParams;
	}
