 ...
 */
public class JokeRefreshLayout extends PtrFrameLayout{
    private static final String TAG = JokeRefreshLayout.class.getSimpleName();

    public JokeRefreshLayout(Context context) {
        super(context);
        initViews(context);
    }

    public JokeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews(context);
    }

    public JokeRefreshLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    private static class RefreshHeader extends FrameLayout implements PtrUIHandler {
        ...
        public RefreshHeader(Context context) {
            super(context);
            View header = LayoutInflater.from(context).inflate(R.layout.header_refresh, this);
        ...
        public void onUIRefreshPrepare(PtrFrameLayout ptrFrameLayout) {
            LogUtil.i(TAG, "onUIRefreshPrepare");
            loadView.setVisibility(GONE);
            pullView.setVisibility(VISIBLE);
            errorView.setVisibility(GONE);
        }
        ...
        public void onUIRefreshBegin(PtrFrameLayout ptrFrameLayout) {
            LogUtil.i(TAG, "onUIRefreshBegin");
        ...
        public void onUIRefreshComplete(PtrFrameLayout ptrFrameLayout) {
            LogUtil.i(TAG, "onUIRefreshComplete");
