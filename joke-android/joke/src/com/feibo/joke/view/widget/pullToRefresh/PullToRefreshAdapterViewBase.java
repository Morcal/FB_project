...
import com.feibo.joke.view.widget.pullToRefresh.internal.EmptyViewMethodAccessor;
import com.feibo.joke.view.widget.pullToRefresh.internal.IndicatorLayout;
    ...
    public final void onScroll(final AbsListView view, final int firstVisibleItem, final int visibleItemCount,
		...
		if (null != mOnLastItemVisibleListener) {
		    if(firstVisibleItem == 0) {
		        mLastItemVisible = totalItemCount > visibleItemCount;
		    } else {
