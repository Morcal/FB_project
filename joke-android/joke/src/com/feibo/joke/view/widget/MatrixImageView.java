...
public class MatrixImageView extends ImageView implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private float computeScale(RectF curr){
        return Math.min(curr.width() / restrictRect.width(), curr.height() / restrictRect.height());
    }
     ...
     */
    private void startRotate(float fromDegree, float toDegree, final PointF rotateCenter){
